  ...
  return (
    <main className="min-h-screen bg-[var(--color-paper)] flex items-center justify-center px-5 py-20">
      <div className="flex flex-col items-center gap-8 w-full max-w-sm">
        ...
        {/* Clerk component — appearance overrides to match cream palette */}
        <SignIn
          appearance={{
            variables: {
              colorPrimary: "#0F6E56",
            ...
            elements: {
              ...
              socialButtonsBlockButton:
                "border border-[var(--color-rule)] bg-[var(--color-paper)] text-[var(--color-ink)] hover:bg-[var(--color-paper-2)] text-sm rounded-[4px] transition-colors",
